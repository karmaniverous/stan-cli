...
#### [0.14.0](https://github.com/karmaniverous/stan-cli/compare/0.13.1...0.14.0)

- updated dependencies [`04c32c8`](https://github.com/karmaniverous/stan-cli/commit/04c32c840c41ac334c13f9c48396220e22b86d4a)
- chore: remove live console commands (q/r) and restart capability [`2b669a7`](https://github.com/karmaniverous/stan-cli/commit/2b669a790194691b27a702308cfb2ddf03bf8562)
- refactor: DRY callable export resolution [`25c6101`](https://github.com/karmaniverous/stan-cli/commit/25c6101403510257c0f69b038b1d5ed1e098614d)
- fix: filter context map by nodeId closure [`7cdb7c9`](https://github.com/karmaniverous/stan-cli/commit/7cdb7c990b5e7a7756282fe4ff3d007518ea2ac8)
- refactor: implement context mode Option B via engine orchestration [`d01b69a`](https://github.com/karmaniverous/stan-cli/commit/d01b69ac5f748faca98a0bf32b4c819e1852855c)
- refactor: decompose cli-utils into domain-specific modules [`d7711ca`](https://github.com/karmaniverous/stan-cli/commit/d7711ca44d83f08ede7821f83987ff9d58b48131)
- fix: honor dependency state during staging [`220401b`](https://github.com/karmaniverous/stan-cli/commit/220401bec10ac946f4ad0beacf4e18612b71a877)
- test: fix smoke script diff logic and error aggregation [`b01940c`](https://github.com/karmaniverous/stan-cli/commit/b01940ce5f23457829638b05485fded79b3966a6)
- docs: remove deprecated facets references [`3be7413`](https://github.com/karmaniverous/stan-cli/commit/3be74130bbbf35ae5c1a8595dc6c129f8a5edaee)
- feat(run): enable context mode Option B (FULL+DIFF) and keyed snapshots [`af76dc4`](https://github.com/karmaniverous/stan-cli/commit/af76dc4a44dfc9d0242b186c3fd97157166af68b)
- fix: label meta archive as meta in UI [`8e30ab2`](https://github.com/karmaniverous/stan-cli/commit/8e30ab2ac88c7481d9eb31872c26c3672217cd90)
- chore: stage TypeDoc triage via dependency state [`ca00e76`](https://github.com/karmaniverous/stan-cli/commit/ca00e76f46957470e9f706e541facc2254312f66)
- feat: add standalone smoke test for context archives [`c3abb07`](https://github.com/karmaniverous/stan-cli/commit/c3abb07f45cf51f482a395912cb665d3a3548518)
- updated stan-core [`80a4350`](https://github.com/karmaniverous/stan-cli/commit/80a43509847dc585891dc6ea5e2808a51100e5ee)
- fix: respect allowlist plan when filtering dep map [`78ac7b6`](https://github.com/karmaniverous/stan-cli/commit/78ac7b635903bb605f3e919f92cd2fe63033b43b)
- test: enhance smoke script for robust context validation [`43d2dce`](https://github.com/karmaniverous/stan-cli/commit/43d2dce0ae3ccadfbddfdf8cf1b994536b980966)
- docs: remove archive.meta.tar refs and document -m flag behavior [`a99f2b6`](https://github.com/karmaniverous/stan-cli/commit/a99f2b68f413c57f4c6e9a0eace19a0e32a215b4)
- feat: add --meta flag for context-mode runs [`b97e0dc`](https://github.com/karmaniverous/stan-cli/commit/b97e0dc96ca0de38d6cb4ea001d575e388a64a6b)
- ## Commit Message [`2ef7d15`](https://github.com/karmaniverous/stan-cli/commit/2ef7d15fcd9b6cad6c7071e78dd6ba9e6f60645a)
- test: add smoke test for archive composition and context mode [`b744458`](https://github.com/karmaniverous/stan-cli/commit/b744458b8318bcfde7b05cde1120098acc6c3ec5)
- chore: plan DRY refactor pass [`bcb1a07`](https://github.com/karmaniverous/stan-cli/commit/bcb1a0746a06a864f6ceda6a447593d7b7e499c7)
- test(snap): use doMock with resetModules and fix lint [`d594e9b`](https://github.com/karmaniverous/stan-cli/commit/d594e9b7d34715d63f20174692a6b1130033010a)
- test(snap): use hoisted mock for core dependencies [`1ee4fec`](https://github.com/karmaniverous/stan-cli/commit/1ee4fec9480f94c6a4ad73e93af1a65e28a0c0df)
- fix: stage context deps only when selected [`ea5a5c9`](https://github.com/karmaniverous/stan-cli/commit/ea5a5c9c96e4773bbf9e74e6b94bbaf37de0a961)
- docs: add TSDoc to exported tooling configs [`b2c4a6b`](https://github.com/karmaniverous/stan-cli/commit/b2c4a6bc460b784d53be7f85ca48c4faccb79b94)
- fix: report selection + drop externals in context [`a2e37a0`](https://github.com/karmaniverous/stan-cli/commit/a2e37a0f182ea9ca20814856f8493a3367ae36d4)
- chore: add stan-core interop note [`f896e89`](https://github.com/karmaniverous/stan-cli/commit/f896e890a2176104ac359bbc4f55c67b1d46edd1)
- docs: update dev plan for context mode refactor [`5f6805d`](https://github.com/karmaniverous/stan-cli/commit/5f6805d2b24162ab1ee39610b4d6196d02edc5cf)
- feat: refine archive composition for context modes [`bd521ac`](https://github.com/karmaniverous/stan-cli/commit/bd521ac98d865f54e70609986900f030c4430d2c)
- test: add detailed failure reporting to smoke script [`a6851a3`](https://github.com/karmaniverous/stan-cli/commit/a6851a33b9b902b5b0de34d77d22981021a60e25)
- docs: align context archive contract [`fc1cf2e`](https://github.com/karmaniverous/stan-cli/commit/fc1cf2ee2411df4a59403befe258f229fbd4017e)
- chore: add stan-core interop note for stop-and-stage gate [`4ad490f`](https://github.com/karmaniverous/stan-cli/commit/4ad490f102c159c78d1a860988dbc9d49dc8bc89)
- fix: pass dependency state to runner for correct diff generation [`e4c390e`](https://github.com/karmaniverous/stan-cli/commit/e4c390ea28e652babef6363894953961d389fe55)
- test: extend smoke-context-diff to verify snap stability [`9770192`](https://github.com/karmaniverous/stan-cli/commit/9770192fe27e792dba6de1430ffdf26a38ab680b)
- updated dependencies [`5f3f1e9`](https://github.com/karmaniverous/stan-cli/commit/5f3f1e93be063e435f2975eb53381cd609681fd5)
- test: increase vitest timeout to 30s for smoke stability [`1ca119b`](https://github.com/karmaniverous/stan-cli/commit/1ca119b20092b1ae257268cfc317a844b5e3ac43)
- chore: add stan-core interop note [`2b29275`](https://github.com/karmaniverous/stan-cli/commit/2b29275e11cfa7ca6042bc6ae20c4d1bf573204e)
- fix: update config test and document meta behavior [`4483eae`](https://github.com/karmaniverous/stan-cli/commit/4483eaecc22784198e88a74c0e2c137c76d850d2)
- chore: seed dependency state for typedoc docs [`a86f3bd`](https://github.com/karmaniverous/stan-cli/commit/a86f3bdb4fe35ffefe80719b2fb0ff4696e84f76)
- test: refine smoke script to verify external dependency selection [`2066e85`](https://github.com/karmaniverous/stan-cli/commit/2066e8534af2d7235c04ab121c7de83c54156b6e)
- fix(runner): propagate dependency context to archive phase [`f0c1b9c`](https://github.com/karmaniverous/stan-cli/commit/f0c1b9c2a814534aad33b8cb9208aa8fde7de0bb)
- fix: skip diff archive row in UI when running with --meta [`d31fe7c`](https://github.com/karmaniverous/stan-cli/commit/d31fe7c17b14d07ec6d57561698de5125f0c316b)
- test: inline stan-core in vitest config [`3b58771`](https://github.com/karmaniverous/stan-cli/commit/3b587719a5d04737755c1ac52dbe1a5b84627f35)
- chore: seed context for DRY refactor [`0eb7f33`](https://github.com/karmaniverous/stan-cli/commit/0eb7f3300b1948eed02b8e527807553dbd69037e)
- ## Commit Message [`0d5fdff`](https://github.com/karmaniverous/stan-cli/commit/0d5fdff6121418ec474893d8f424c02a706e9c56)
- fix: disable combine mode in context runs to satisfy engine constraints [`02ec54c`](https://github.com/karmaniverous/stan-cli/commit/02ec54cdf3d2d4a4e09d0b8743ad22f939b30103)
- fix: resolve build errors and update smoke test for context mode [`2a4354d`](https://github.com/karmaniverous/stan-cli/commit/2a4354d08e005d13b47ffda6348a919c930b6edb)
- updated dependency [`8668900`](https://github.com/karmaniverous/stan-cli/commit/8668900c2f14ed7c2e388a150ff76093976f9374)
- fix: resolve typecheck errors from cli-utils refactor [`32268f0`](https://github.com/karmaniverous/stan-cli/commit/32268f0598a1729502640b2693126abeb0b0bf0c)
- test: print dependency meta and state in smoke script [`22ea3d6`](https://github.com/karmaniverous/stan-cli/commit/22ea3d6113bd0c580c54f9c0dd89e1d9d524fb84)
- test(snap): fix mock and enable context smoke test [`b4e02b4`](https://github.com/karmaniverous/stan-cli/commit/b4e02b44a4e3286e22cc1bb0b5a06032ef746272)
- chore: seed context for DRY refactor [`b6bd226`](https://github.com/karmaniverous/stan-cli/commit/b6bd22633b534895cd370e624f8db09e5f0b49e5)
- docs: update guides and requirements to reflect removal of q/r keys [`57d2279`](https://github.com/karmaniverous/stan-cli/commit/57d22796093c5d32754786d4d64c5986b999498e)
- chore: stage modules for DRY refactor [`0c36b77`](https://github.com/karmaniverous/stan-cli/commit/0c36b77b12da2239f5ceb248676c7164d11fa503)
- fix: remove redundant try/catch in cli/index.ts (lint) [`3ae0116`](https://github.com/karmaniverous/stan-cli/commit/3ae0116260877c9e17636e3b19d7168f62d4abf9)
- chore: seed dependency state for TypeDoc sweep [`eabdd22`](https://github.com/karmaniverous/stan-cli/commit/eabdd220982e158bba4e8e122829f4c707bfd6e7)
- test(snap): fix type cast and avoid restoreAllMocks [`3379190`](https://github.com/karmaniverous/stan-cli/commit/337919030bf99a553fdea9c894854ca79d45ca46)
- test: ensure fresh dependency graph in smoke script [`7a9cf68`](https://github.com/karmaniverous/stan-cli/commit/7a9cf68416663cfd150a8ecf3a5b004a03a7b813)
- fix: resolve __dirname in ESM smoke script [`1bc2863`](https://github.com/karmaniverous/stan-cli/commit/1bc2863cee6952cc471aeca63c26a4b475896e45)
- test(cli): fix patch failure simulation and snap mock reset [`252c4ff`](https://github.com/karmaniverous/stan-cli/commit/252c4ff5d0a6a0bf24e4623d22c5634d0c053736)
- docs: re-export dependency types from main entrypoint [`a64cc0c`](https://github.com/karmaniverous/stan-cli/commit/a64cc0c92a808b532ac2e53cf3fd2df2c467f9b6)
- test(smoke): fix tsx path resolution [`c95e56c`](https://github.com/karmaniverous/stan-cli/commit/c95e56ca9e5ab77653f45a490d632971e03efda8)
- updated stan-core [`f1324e1`](https://github.com/karmaniverous/stan-cli/commit/f1324e1efe12a0398111e15f9871165b85d8661c)
- updated dependencies [`3473358`](https://github.com/karmaniverous/stan-cli/commit/3473358447199a51e26373ff8543bb93f001ddfe)
- docs: export DependencyMetaResult to fix TypeDoc warning [`a226e87`](https://github.com/karmaniverous/stan-cli/commit/a226e87200193e0243872336474c5614f28a5f8a)
- fix: remove redundant conditional in cli/index.ts (lint) [`2468192`](https://github.com/karmaniverous/stan-cli/commit/24681922572e909cfa1d792bd5a5253b74c0a041)
- chore: shrink dependency state selection diffs [`e67ad39`](https://github.com/karmaniverous/stan-cli/commit/e67ad3923d2f246df39090776e5a7b4fd5db2530)
- chore: add smoke script to knip entrypoints [`7ef8f81`](https://github.com/karmaniverous/stan-cli/commit/7ef8f8162c0568c11b234a11842dcab8ab01fd3a)

#### [0.13.1](https://github.com/karmaniverous/stan-cli/compare/0.13.0...0.13.1)

> 26 January 2026

- chore: release v0.13.1 [`0ac2ea1`](https://github.com/karmaniverous/stan-cli/commit/0ac2ea1a7f13675e187a4ca903a2367339125c92)
- fix: wire createMetaArchive to respect config and combine mode [`598a56e`](https://github.com/karmaniverous/stan-cli/commit/598a56e8a7260fdd87a1b58bdba028d8db109dcb)

#### [0.13.0](https://github.com/karmaniverous/stan-cli/compare/0.13.0-3...0.13.0)

> 26 January 2026

- chore: release v0.13.0 [`8df1a9f`](https://github.com/karmaniverous/stan-cli/commit/8df1a9fc03373a1c93b255e21cd191b4a8dc2087)
